...
<div class="container">
  <div class="row ">
    <div class="col-6">
      <div class="infomation-left container" style="float: left; padding-left: 12px;margin-top: 50px;font-size: small">
			...
			<div class="Subtotal" style="margin-top: 30px">
				<table class="table border-0 table-borderless">
  					<tbody>
   					 ...
   					 <tr>
      					<td>Shipping</td>
     					<td style="text-align: center;">Calculated at next step</td>
    </tr>
  </tbody>
</table>
			</div>
