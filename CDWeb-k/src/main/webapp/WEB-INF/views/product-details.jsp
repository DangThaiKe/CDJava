...
<div class="container">
  <div class="row ">
    <div class="col-md-6">
<!-- hiện thị ảnh -->
      <div id="carouselExampleDark" class="carousel carousel-dark slide " data-bs-ride="carousel" style="width: 700px;height: 750px;padding-top: 70px;float: left;margin-left: -156px">
...
<!-- hiện thị chi tiết thông tin sp -->
	<div class="product-content col-xs-12 col-md-6 d-flex align-items-center justify-content-center " style="background:#f5f5f5;padding-left: 50px;width: 850px;padding-top: 130px">
		<div class="no-stick">
